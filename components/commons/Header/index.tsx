...
export function Header() {
  ...
  const description =
    "Hi! My name is Fadil, and I'm a software engineer that always eager to learn in hope to solve everyday problems from the smallest to the big by using code.";
  return (
    <Head>
      <title>{title}</title>
      <meta
        name="description"
        content={"Porfolio website for Muhammad Fadhilah Mulyana"}
      />
